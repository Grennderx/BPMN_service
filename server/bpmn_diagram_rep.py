...
class BpmnDiagramGraph(object):
    ...
    def add_flow_node_to_diagram(self, process_id, node_type, name, node_id=None, x=100, y=100):
        """
        ...
        self.diagram_graph.nodes[node_id][consts.Consts.x] = str(x)
        self.diagram_graph.nodes[node_id][consts.Consts.y] = str(y)
